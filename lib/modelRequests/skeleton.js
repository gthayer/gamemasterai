...
export const skeletonRequest = async (prompt, debug) => {
	...
	prompt = `Create a 5e monster stat block based on the user's prompt. Return a response in a markdown format using this example. Include line breaks: ${exampleBlock}\
