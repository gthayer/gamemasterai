...
CREATE TABLE `Account` (
    ...
    `promoTokens` INTEGER NULL,
    `paidTokens` INTEGER NULL,
...
-- AddForeignKey
ALTER TABLE `StatBlock` ADD CONSTRAINT `StatBlock_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `User`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
